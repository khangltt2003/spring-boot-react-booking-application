    ...
    <Card className=" max-w-[26rem] shadow-lg hover:shadow-2xl hover:scale-105 transition-all rounded-none ">
      ...
      <CardBody>
        <div className="flex items-center justify-between mb-1">
          <Typography variant="h6" color="blue-gray" className="font-base">
            {room.type}
          </Typography>
          <Typography color="blue-gray" className="flex items-center gap-1.5 font-normal">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="-mt-0.5 h-4 w-4 text-yellow-700">
              <path
                fillRule="evenodd"
      ...
      <CardFooter className="pt-0">
        <a href={`/room/${room.id}`}>
          <Button size="" fullWidth={true} className="rounded-lg">
